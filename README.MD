...
| ```bot:setLocalBotId(int botId);``` | Sets the local bot ID for the bot. Be sure to set the bot ID in any case, otherwise the onSendPacket, onSendRPC, onReceivePacket, onReceiveRPC callbacks will not work |
